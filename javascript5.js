...
//BASE DE DATOS
var productos = ["Saco de Telar de Cintura", "Saco de Telar de Cintura", "Saco de Telar de Cintura", "Blusa Bordada con olanes", "Chaleco de Telar de Pedal", "Camisa de Dama bordada", "Blusa Bordada Manga Larga", "Blusa Bordada Manga Larga", "Blusa Bordada Manga Larga"];
var imgGrandes = ["img/producto28.jpg", "img/producto29.jpg", "img/producto30.jpg", "img/producto27.jpg", "img/producto35.jpg", "img/producto84.jpg", "img/producto86.jpg", "img/producto87.jpg", "img/producto88.jpg"];
var imgPeque = ["img/producto28.jpg", "img/producto29.jpg", "img/producto30.jpg", "img/producto27.jpg", "img/producto35.jpg", "img/producto84.jpg", "img/producto86.jpg", "img/producto87.jpg", "img/producto88.jpg"];
var precios = [550, 550, 550, 1400, 550, 990, 490, 490, 490];
var talla =["Unitalla", "Unitalla", "Unitalla","Mediana", "Unitalla", "Mediana", "Grande", "Grande", "Grande"];
...
/**/			document.getElementById("divPago").className = "divsNo";				
            ...
            '<tr class="proCarrito"><td>' +productos[i]+ '</td><td>' +uniUser[i].value+ '</td><td>' +precios[i]+ '</td><td id="preTotal' +i+'" name="preTotal">' +preTotal+ '</td></tr>';
        }
    }
...
function validaDatosPagoYEnviaCarro(elEvento) {
    alert("PEDIDO CONFIRMADO\n¡Gracias por su compra!\nEl número de guía es: 0123449938490933\nPaqueteía FedEx");
